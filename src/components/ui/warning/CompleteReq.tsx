...
const CompleteReq = () => {
  ...
  return (
    <div className="border border-[#E5E7EB] bg-[#FFFFFF] flex items-center py-4 px-6 rounded-xl justify-between w-full max-w-121">
      ...
      <button
        onClick={openProfile}
        className="flex items-center bg-[#EEEDFC] border border-[#B7B3F4] text-[#281ED2] rounded-lg w-29 h-12 justify-center cursor-pointer gap-2"
      >
        Complete <img src={ArrowRightIcon} alt="arrow right icon" />
      </button>
    </div>
  );
};
